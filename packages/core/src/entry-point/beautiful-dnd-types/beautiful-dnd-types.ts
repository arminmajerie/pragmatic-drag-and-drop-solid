...
export type Scrollable = {
  ...
  pageMarginBox: Rect,
  // Used for comparison with dynamic recollecting
  frameClient: BoxModel,
  scrollSize: ScrollSize,
  // Whether we should clip the subject by the frame
...
// SNAP: items move in response to commands (e.g. keyboard);
...
export type DraggingState = {
  ...
  // whether draggable movements should be animated
...
export type CollectingState = DraggingState & {
  phase: 'COLLECTING',
};
...
// a drop
export type DropPendingState = DraggingState & {
  phase: 'DROP_PENDING',
  isWaiting: boolean,
  reason: DropReason,
};
