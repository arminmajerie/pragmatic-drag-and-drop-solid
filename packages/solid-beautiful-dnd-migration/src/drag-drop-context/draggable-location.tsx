// packages/solid-beautiful-dnd-migration/src/drag-drop-context/draggable-location.tsx
import type { DraggableLocation } from '@arminmajerie/pragmatic-drag-and-drop/types';
import { extractClosestEdge } from '@arminmajerie/pragmatic-drag-and-drop-hitbox/closest-edge';
import type { DragLocation } from '@arminmajerie/pragmatic-drag-and-drop/types';
