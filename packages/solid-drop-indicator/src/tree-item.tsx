// packages/solid-drop-indicator/src/tree-item.tsx
import type { JSX } from 'solid-js';

import type { Instruction } from '@arminmajerie/pragmatic-drag-and-drop-hitbox/tree-item';
...
export function DropIndicator({ instruction }: DropIndicatorProps): JSX.Element | null {
